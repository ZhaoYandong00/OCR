...
public class MainActivity extends AppCompatActivity {
    ...
    static final String TESSBASE_PATH = "/storage/self/primary/Download/tesseract";
    //识别语言英文
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.simplechinesetext = findViewById(R.id.simple_chinese_text);
        this.simplechinese =  findViewById(R.id.simple_chinese);
